...
export const referencePatternPack: Record<ReferenceStyle, ReferencePattern> = {
  "검색 유입 정보형": {
    ...
    enrichers: ["제품보다 현재 상황의 판단 기준을 설명", "입력에 있는 준비 정보만 필요한 만큼 안내", "제품 장점은 검색 의도와 연결"],
  ...
  "답례품 추천형": {
    ...
    introFlow: ["전달할 순간에 생기는 고민", "너무 가볍거나 과한 선물을 피하고 싶은 마음", "이번 글에서 풀 선택 기준"],
    sectionFlow: ["도입부", "상황 공감", "첫 번째 제품 기준", "두 번째 제품 기준", "이런 분들께 좋아요", "준비 전 체크포인트", "FAQ", "마무리 CTA"],
  ...
  "제품 디테일형": {
    ...
    introFlow: ["제품을 찾게 되는 상황", "이번 상황에서 볼 제품 특징", "오늘 소개할 디테일 예고"],
